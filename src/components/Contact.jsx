      ...
      <div className="mx-auto max-w-7xl px-6 grid lg:grid-cols-2 gap-12">
        <div>
          ...
          <form className="space-y-4">
            ...
            <motion.button whileHover={{ scale: 1.02 }} whileTap={{ scale: 0.98 }} className="px-5 py-3 rounded-md bg-blue-500/90 hover:bg-blue-400 text-white shadow-lg shadow-blue-500/20 transition-colors">Submit</motion.button>
          </form>
        ...
        <div className="relative">
          <div className="sticky top-24 p-6 rounded-xl bg-gradient-to-br from-slate-900/60 to-slate-900/30 border border-white/10 text-gray-200">
